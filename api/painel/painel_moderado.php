    ...
    <div class="content">
        ...
        <div class="container">
            <div class="row" id="investimento">
                <div class="col-sm-4 card-inv"><h3 class="text-white f-300">Ações e Bolsa de Valores - B3</h3><p class="text-white">Plataforma oficial para investir em ações com um equilíbrio entre segurança e rentabilidade.</p> <a href="" class="btn btn-outline-light">clique aqui</a></div>
                <div class="col-sm-4 card-inv"><h3 class="text-white f-300">Criptomoedas - Binance Academy</h3><p class="text-white">Guia educacional para entender e diversificar seus investimentos com criptomoedas.</p> <a href="" class="btn btn-outline-light">clique aqui</a></div>
                <div class="col-sm-4 card-inv"><h3 class="text-white f-300">Private Equity - Harvard Business Review</h3><p class="text-white">Artigo sobre como equilibrar riscos em investimentos de empresas privadas.</p> <a href="" class="btn btn-outline-light">clique aqui</a></div>
            </div>
            <br>
