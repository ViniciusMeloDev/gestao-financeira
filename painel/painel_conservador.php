...
<body>
    ...
    <div class="content">
        ...
        <div class="container">
            <div class="row" id="investimento">
                <div class="col-sm-4 card-inv"><h3 class="text-white f-300">Renda Fixa - Tesouro Direto</h3><br><p class="text-white">Plataforma segura para investir em títulos públicos e garantir rentabilidade.</p> <a href="" class="btn btn-outline-light">Clique aqui</a></div>
                <div class="col-sm-4 card-inv"><h3 class="text-white f-300">CDBs - Certificados de Depósito Bancário</h3><p class="text-white">Uma opção segura e rentável para quem busca menor risco.</p> <a href="" class="btn btn-outline-light">Clique aqui</a></div>
                <div class="col-sm-4 card-inv"><h3 class="text-white f-300">Fundos Imobiliários - FIIs</h3><p class="text-white">Investimento em imóveis sem precisar comprar um imóvel físico.</p> <a href="" class="btn btn-outline-light">Clique aqui</a></div>
            </div>
            <br>
    ...
    <script>
        ...
        // Chama a função para buscar valores das moedas
        fetchCurrencyValues();

        // Configura e exibe o gráfico da Bolsa de Valores
